    ...
    class Meta:
        ...
        help_texts = {
            'deadline': 'Чтобы сделать промокод бессрочным, оставьте поле пустым. '
                        'Рекомендуем перепроверить дату, так как из-за системных настроек '
                        'в поле может сначала стоять месяц, а затем день. '
                        'Для перепроверки можете нажать на иконку календаря или на само поле.',
